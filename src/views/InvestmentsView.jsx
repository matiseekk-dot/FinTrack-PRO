...
function InvestmentsView({ portfolio, setPortfolio, accounts = [] }) {
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      {importModal && (
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "#000000cc", zIndex: 200,
      ...
      {/* Modal dodaj/edytuj */}
      {modal && (
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "#000000cc", zIndex: 200, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
